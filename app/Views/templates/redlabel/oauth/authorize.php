    ...
    <div class="container form-container">
        <div class="row">
            <div class="auth-form">
                ...
                <form class="form-horizontal" method="post" action="<?= site_url('oauth/authorize') ?>">
...
<script>
    ...
    function changeAccount() {
        ...
        fetch("<?= site_url('oauth/changeAccount') ?>?" + queryParams, {
            method: 'POST',
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = "<?= site_url('oauth/authorize') ?>?" + queryParams;
            } else {
