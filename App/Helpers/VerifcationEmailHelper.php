...
class VerifcationEmailHelper
{

    function generateEmailHTML($verifyLink,$name)
    {
    ...
    function generateEmailHTML_en($verifyLink,$name)
    {
        ...
        <body>
            <div class="container">
                ...
                <hr style="margin-top: 5px;">
                    ...
                    <a style="font-size:12px;" href="' . $verifyLink . '">'.$verifyLink.'</a>
