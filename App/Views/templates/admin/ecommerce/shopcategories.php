<div id="languages">
    ...
    if (session('result_add')) {
        ?>
        <div class="alert alert-success"><?= session('result_add') ?></div>
        <hr>
        <?php
    }
    if (session('result_delete')) {
        ?>
        <div class="alert alert-success"><?= session('result_delete') ?></div>
        <hr>
        <?php
    }
    ?>
