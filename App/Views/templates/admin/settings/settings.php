...
<div class="row">
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultSiteLogoPublish')) { ?>
                    <div class="alert alert-info"><?= session('resultSiteLogoPublish') ?></div>
                <?php } ?>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultNaviText')) { ?>
                    <div class="alert alert-info"><?= session('resultNaviText') ?></div>
                <?php } ?>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultFooterCopyright')) { ?>
                    <div class="alert alert-info"><?= session('resultFooterCopyright') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <div class="input-group">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultContactspage')) { ?>
                    <div class="alert alert-info"><?= session('resultContactspage') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultfooterContacts')) { ?>
                    <div class="alert alert-info"><?= session('resultfooterContacts') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultGoogleMaps')) { ?>
                    <div class="alert alert-info"><?= session('resultGoogleMaps') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultFooterAboutUs')) { ?>
                    <div class="alert alert-info"><?= session('resultFooterAboutUs') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <div class="input-group">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultfooterSocial')) { ?>
                    <div class="alert alert-info"><?= session('resultfooterSocial') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <div class="form-group" style="position: relative;">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('resultEmailTo')) { ?>
                    <div class="alert alert-info"><?= session('resultEmailTo') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <div class="input-group">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('shippingOrder')) { ?>
                    <div class="alert alert-info"><?= session('shippingOrder') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <div class="input-group">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('addJs')) { ?>
                    <div class="alert alert-info"><?= session('addJs') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('publicQuantity')) { ?>
                    <div class="alert alert-info"><?= session('publicQuantity') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('publicDateAdded')) { ?>
                    <div class="alert alert-info"><?= session('publicDateAdded') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('multiVendor')) { ?>
                    <div class="alert alert-info"><?= session('multiVendor') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('outOfStock')) { ?>
                    <div class="alert alert-info"><?= session('outOfStock') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('hideBuyButtonsOfOutOfStock')) { ?>
                    <div class="alert alert-info"><?= session('hideBuyButtonsOfOutOfStock') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('refreshAfterAddToCart')) { ?>
                    <div class="alert alert-info"><?= session('refreshAfterAddToCart') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('moreInfoBtn')) { ?>
                    <div class="alert alert-info"><?= session('moreInfoBtn') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('showBrands')) { ?>
                    <div class="alert alert-info"><?= session('showBrands') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('showInSlider')) { ?>
                    <div class="alert alert-info"><?= session('showInSlider') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('cookieNotificator')) { ?>
                    <div class="alert alert-info"><?= session('cookieNotificator') ?></div>
                <?php } ?>
                <form method="POST" action="">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                <?php if (session('virtualProducts')) { ?>
                    <div class="alert alert-info"><?= session('virtualProducts') ?></div>
                <?php } ?>
                <form method="POST" action="">
