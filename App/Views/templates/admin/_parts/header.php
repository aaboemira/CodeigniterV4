                        ...
                        <?php if (session('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <?php if (isset($showBrands) && $showBrands == 1) { ?>
                                    ...
                                    <li><a href="<?= base_url('admin/shipping') ?>" <?= urldecode(uri_string()) == 'admin/shipping' ? 'class="active"' : '' ?>><i class="fa fa-ship" aria-hidden="true"></i> Free Shipping</a></li>
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10 col-sm-offset-3 col-md-offset-3 col-lg-offset-2">
                                <?php if (isset($warnings) && $warnings != null) { ?>
