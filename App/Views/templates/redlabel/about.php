        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <h1 class="h1">
                        <?= lang_safe('contact_us') ?> <small><?= lang_safe('contact_us_feel_free') ?></small></h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="subject">
                                        <?= lang_safe('subject') ?></label>
                                    <input type="text" name="subject" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label for="upload">
                                        <?= lang_safe('file_upload') ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" class="form-control" rows="9" cols="25" required="required"
                                              placeholder="<?= lang_safe('message') ?>"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary pull-right" id="btnContactUs">
                                    <?= lang_safe('send_message') ?></button>
                            </div>
                        </div>
                    </form>
                </div>
