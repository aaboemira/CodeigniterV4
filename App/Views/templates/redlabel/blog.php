    ...
    <div class="row eqHeight">
        <div class="col-sm-4 col-md-3">
                ...
                <div class="input-group col-md-12">
                    <form method="GET" action="">
                        <input type="text" class="search-query form-control"
                            value="<?= isset($_GET['find']) ? htmlspecialchars($_GET['find']) : '' ?>" name="find"
                            placeholder="<?= lang_safe('search') ?>" />
            ...
            <div class="filter-sidebar">
                <div class="title">
                    <span><?= lang_safe('best_sellers') ?></span>
        ...
        <div class="col-sm-8 col-md-9">
            <div class="alone title">
                <span><?= lang_safe('latest_blog') ?></span>
            </div>
            <div class="row">
                <?php
                if (!empty($posts)) {
                ...
                <?php
                    ...
                    ?>
                <div class="alert alert-info"><?= lang_safe('no_posts') ?></div>
                <?php } ?>
            </div>
            <?= $links_pagination ?>
        </div>
