<div class="container container-sm" id="checkout-page">
    ...
    <?php
        ...
        $discountCodeResult['discount_amount'] = $discountAmount;
            ...
            <form method="POST" id="goOrder">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-7 col-xs-12"
                            ...
                            <div class="flex-div">
                                ...
                                <a class="change_address" onclick="changeAddress()"><?=lang_safe('checkout3_change_address')?></a>
                                <?php endif?>
                            </div>
                            <div>
                ...
                <div class="container mt-15" id="shopping-cart" style="padding-left: 0 !important;">
                    ...
                    <div style="padding-right: 8px;">
                        ...
                        <div class="discount align-right">
                            <input class="form-control discount-form align-right" name="discountCode"
                                value="<?= @$_POST['discountCode'] ?>" placeholder="<?= lang_safe('enter_discount_code') ?>"
                                type="text">
                    ...
                    <input id="goOrder" class="form-control" style="display:none" name="goOrder"
                        value="<?= @$_POST['goOrder'] ?>" type="text" placeholder="">
