<div class="container" id="view-product">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <?php } ?>
            <div class="row row-info">
                <div class="col-sm-6"><b><?= lang_safe('num_added_to_cart') ?>:</b></div>
            ...
            <?php if ($publicDateAdded == 1) { ?>
                <div class="row row-info">
                    <div class="col-sm-6"><b><?= lang_safe('added_on') ?>:</b></div>
                    <div class="col-sm-6"><?= date('m.d.Y', $product['time']) ?></div>
                    <div class="col-sm-12 border-bottom"></div>
                </div>
            <?php } ?>
            <div class="row row-info">
                <div class="col-sm-6"><b><?= lang_safe('in_category') ?>:</b></div>
                <div class="col-sm-6">
            ...
            <div class="row row-info">
                <div class="col-xs-12"><b><?= lang_safe('description') ?>:</b></div>
            </div>
            <div id="description">
                <?= $product['description'] ?>
            </div>
    ...
    <div class="row orders-from-category" id="products-side">
        ...
        if (!empty($sameCagegoryProducts)) {
            ...
            ?>
            <div class="alert alert-info"><?= lang_safe('no_same_category_products') ?></div>
            <?php
        }
        ?>
    </div>
