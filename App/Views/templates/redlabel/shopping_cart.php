...
if (!isset($cartItems['array'])) {?>
    ...
    <div class="container mt-15" id="shopping-cart">
        <div class="title alone">
            <span><?=lang_safe('shopping_cart')?></span>
        </div>
                ...
                <tbody style="font-size: medium;">
                    <?php foreach ($cartItems['array'] as $item) {?>
                        ...
                        <td class="v-align-top produkt">
                            <div class="flex">
                                ...
                                <div class="max-675-counter max-675">
                                    <a class="btn btn-xs bg-white text-black " onclick="removeProduct(<?=$item['id']?>, true)" href="javascript:void(0);">
                                    <span>
                                    <span class="">
                                        <svg  class="max-675-wh-minus" width="14" height="12" viewBox="0 0 58 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                class="btn btn-xs refresh-me add-to-cart bg-white text-black border-none <?=$item['quantity'] <= $item['num_added'] ? 'disabled' : ''?>"
                                    ...
                                    <span>
                                        <svg class="max-675-wh-plus" width="14" height="12" viewBox="0 0 58 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <line y1="27.5" x2="58" y2="27.5" stroke="black" stroke-width="5"/>
                                ...
                                <div class="flex flex-col ml-5 max-675-item-price">
                                    ...
                                    <a class="text-underlined-none text-black" href="<?=LANG_URL . '/' . $item['url']?>"><span class="text-uppercase  fs-15 "><?=$item['title']?></span></a>
                        ...
                        <td class="align-center v-align-top menge min-675">
                            <a
                                class="btn btn-xs bg-white text-black" onclick="removeProduct(<?=$item['id']?>, true)">
                                <span>
                                <span>
                                    <svg  class="minus-svg-min-675" width="14" height="12" viewBox="0 0 58 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <line y1="27.5" x2="58" y2="27.5" stroke="black" stroke-width="5"/>
                                    </svg>
                                </span>
                                </span>
                            ...
                            <a class="btn btn-xs refresh-me add-to-cart bg-white text-black border-none <?=$item['quantity'] <= $item['num_added'] ? 'disabled' : ''?>"
                                ...
                                <span>
                                    <svg class="plus-svg-min-675"  width="14" height="12" viewBox="0 0 58 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <line y1="27.5" x2="58" y2="27.5" stroke="black" stroke-width="5"/>
                                        <line x1="29.5" y1="56" x2="29.5" stroke="black" stroke-width="5"/>
                                    </svg>
                                </span>
        ...
        <div  class="fw-bold text-black align-right min-675 fs-12 mb-1"><?=lang_safe('total')?> :
            <span class="ml-14"><?=$cartItems['finalSum'] . CURRENCY?></span>
        </div>
        <div class="text-black min-675 align-right mb-10">
            <span><?=lang_safe('mwst')?></span>
        </div>
        <div  class="fw-bold text-black align-right max-675 max-675-gesamt"><div class="max-675-justify-between">
