<div class="inner-nav">
    <div class="container">
        <a href="<?= LANG_URL ?>"><?= lang_safe('home') ?></a> <span class="active"> > <?= lang_safe('user_login') ?></span>
    </div>
</div>
        ...
        <div class="col-sm-4">
            <div class="loginmodal-container">
                ...
                <form method="POST" action="">
                    ...
                    <input type="submit" name="update" class="login loginmodal-submit" value="<?= lang_safe('update') ?>">
                    <a href="<?= LANG_URL . '/logout' ?>" class="login loginmodal-submit text-center"><?= lang_safe('logout') ?></a>
                </form>
            </div>
        </div>
        <div class="col-sm-8">
                ...
                <table class="table table-condensed table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        if (!empty($orders_history)) {
                                    ...
                                    <td>    
                                        ...
                                        foreach ($arr_products as $product) {
                                            ...
                                            <div style="word-break: break-all;">
                                                ...
                                                <div style=" background-color: #f1f1f1; border-radius: 2px; padding: 2px 5px;"><b><?= lang_safe('user_order_quantity') ?></b> <?= $product['product_quantity']; ?></div>
                            ...
                            ?>
                            <tr>
                                <td colspan="5"><?= lang_safe('usr_no_orders') ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
